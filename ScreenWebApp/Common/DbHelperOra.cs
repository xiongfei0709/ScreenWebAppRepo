...
namespace ScreenWebApp.Conmmon
{
    ...
    public abstract class DbHelperOra
    {
        ...
        public static string connectionString = Function.Setting["AppSettings:OracleConnectionString"];
        public DbHelperOra()
        {
            //connectionString = Function.ReadConfig("AppSettings:OracleConnectionString");
            //connectionString = Function.Setting["AppSettings:OracleConnectionString"];            
        }
